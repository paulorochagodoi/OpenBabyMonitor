...
if (isset($_POST['submit'])) {
  ...
  reconcileFeatureService($setting_type, $values['enabled']);
  ...
  <div class="d-flex flex-column fillview">
    ...
    <div class="d-flex flex-column flex-grow-1 justify-content-center overflow-auto">
      <main id="main_container" class="fillview" style="display: none;">
        <div class="container">
          <h1 class="my-4"><?php echo LANG['nightlight_settings']; ?></h1>
          <form id="nightlight_settings_form" action="" method="post">
            <div class="row">
...
<script>
  const SETTINGS_FORM_ID = 'nightlight_settings_form';
  ...
  const SITE_MODE = -1; // Not a mode: settings changes are applied by the feature service, not a mode restart.
