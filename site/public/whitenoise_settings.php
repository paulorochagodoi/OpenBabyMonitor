  ...
  <div class="d-flex flex-column fillview">
    ...
    <div class="d-flex flex-column flex-grow-1 justify-content-center overflow-auto">
      <main id="main_container" class="fillview" style="display: none;">
        <div class="container">
          <h1 class="my-4"><?php echo LANG['whitenoise_settings']; ?></h1>
          <form id="whitenoise_settings_form" action="" method="post">
            <div class="row">
...
<script>
  const SETTINGS_FORM_ID = 'whitenoise_settings_form';
