      ...
      <ul class="navbar-nav w-100 mb-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" style="min-width: 1em;">
            ...
            <li><a id="whitenoise_settings_nav_link" class="dropdown-item<?php echo LOCATION == 'whitenoise_settings' ? ' active' : ''; ?> d-flex align-items-center" href="whitenoise_settings.php">
                <svg class="bi me-2" style="height: 1.1em; width: 1.1em;" fill="currentColor">
